...
export const gooseActionIcon = svg`<svg slot="onIcon" viewBox="0 0 24 24">${pathsSVG.gooseIcon}</svg>`;
export const smvActionIcon = svg`<svg slot="offIcon" viewBox="0 0 24 24">${pathsSVG.smvIcon}</svg>`;
