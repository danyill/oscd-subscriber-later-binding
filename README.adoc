...
It offers either both a publisher and subscriber view of the data flows to allow efficient and intuitive use.
...
image::screenshot-add-extension.png[]
...
+
image::screenshot-openscd-core-add.png[width=400]
...
This plugin was refactored from base code in OpenSCD and relies on the code, architecture and review effort of multiple people other than the author of this plugin, including:
